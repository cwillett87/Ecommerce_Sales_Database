"""
Django settings for sales_database project.
...
ROOT_URLCONF = 'sales_database.urls'
...
WSGI_APPLICATION = 'sales_database.wsgi.application'
...
DJOSER = {
    ...
    'SERIALIZERS': {
        ...
        'user': 'sales.serializers.UserCreateSerializer',
    },
}
